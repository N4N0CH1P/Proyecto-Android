...
class DetailActivity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        label_identifier.visibility = View.INVISIBLE
        text_identifier.visibility = View.INVISIBLE
        ...
        Executor.ioThread {
            cant = instanceDatabase.scanDao().getAnyScan()
        }
        }
                        ...
                        if(NetworkConnection.isNetworkAvailable(this))
                        {
                            ...
                            if(paciente!=null)
                            {
                                ...
                                datosPost+= URLEncoder.encode("presionID", "UTF-8") + "=" +
                                        URLEncoder.encode(cant.toString(), "UTF-8")
